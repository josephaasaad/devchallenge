  ...
  <div class="container">
    ...
    <form action="insert.php" method="get">
      ...
      <div class="form-group">
        ...
        <textarea style="white-space: pre-line" class="form-control" name= "preview_text" id="preview_text" rows="3" placeholder="Preview Text"></textarea>
      </div>
      <div class="form-group">
        <label for="body">Body</label>
        <textarea style="white-space: pre-line" class="form-control" name= "body" id="body" rows="10" placeholder="Body"></textarea>
      </div>
