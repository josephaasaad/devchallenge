  ...
  <body>
    ...
    <div class="container">
      <div class="content">
        ...
        <button  class="btn btn-dark float-right" data-toggle="modal" data-target="#shareModal">Share</button><span class="clearfix"></span>
              ...
              <div class="modal-body">
                <div class="input-group mb-3">
                  ...
                  <div class="input-group-append">
                    <a id="copying" action="<?php updateSharedLinks($id+1,$uniqid);?>" class="btn btn-success float-right" value="copying">copy</a>
                  </div>
                  <script>
